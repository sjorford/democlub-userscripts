...
(function() {
	...
	function shortOrgName(text, slug) {
		...
		if (shortName == 'City of London Common Council' || shortName == 'City of London Corporation' || shortName == 'City of London') return 'City of London';
